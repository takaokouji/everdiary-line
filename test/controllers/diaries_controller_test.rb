...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference("Diary.count") do
      post diaries_url, params: { diary: { content: @diary.content, user_id: @diary.user_id, written_on: @diary.written_on } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { content: @diary.content, user_id: @diary.user_id, written_on: @diary.written_on } }
